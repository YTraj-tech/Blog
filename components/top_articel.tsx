...
const TopArticles = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      {/* Content Container */}
      <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 justify-center gap-6 px-4 sm:px-20 py-6">
        {articles.length === 0 ? (
          <div className="col-span-1 sm:col-span-2 text-center py-16">
          ...
          articles.slice(0, 4).map((article) => (
            ...
            >
              <div
                className="relative bg-white/95 backdrop-blur-xl rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-white/20 hover:border-white/30 h-[600px] flex flex-col"
                onClick={() => window.location.href = `/articels/${article.id}`}
              >
                {/* Trending Badge */}
                <div className="absolute top-4 left-4 z-10">
                  <span className="bg-gray-900/90 backdrop-blur-sm text-white px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1 shadow-lg">
                    <TrendingUp className="w-3 h-3" />
                    Trending
                  </span>
                </div>
                ...
                <div className="relative w-full h-52 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden flex-shrink-0">
                  {article.featuredImage ? (
                    <Image
                      src={article.featuredImage}
                      alt={article.title}
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  {/* Title - Fixed Height */}
                  <h3 className="text-lg font-bold text-gray-900 line-clamp-2 leading-tight group-hover:text-blue-600 transition-colors duration-200 mb-3 h-12">
                    {article.title}
                  </h3>
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center overflow-hidden flex-shrink-0">
                      {article.author.imageUrl ? (
                        <Image
                          src={article.author.imageUrl}
                          alt={article.author.name}
                  ...
                  <div className="mt-auto">
                    ...
                    <Button
                      className="w-full bg-gray-900 hover:bg-gray-800 text-white font-medium py-2 rounded-lg transition-colors duration-200"
                      onClick={(e) => {
                        e.stopPropagation();
                        window.location.href = `/articles/${article.id}`;
                      }}
